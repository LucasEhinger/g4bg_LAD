...
g4rcOpticalPhysics::g4rcOpticalPhysics(G4bool toggle)
...
g4rcOpticalPhysics::~g4rcOpticalPhysics() { }
...
void g4rcOpticalPhysics::ConstructParticle()
{
...
void g4rcOpticalPhysics::ConstructProcess()
{
    /*

FIXME:  Add to verbosity responsiveness
    G4cout << "g4rcOpticalPhysics:: Add Optical Physics Processes"
           << G4endl;
	   */
  ...
  if (!pManager) {
     ...
     G4Exception("g4rcOpticalPhysics::ConstructProcess()","",
...
void g4rcOpticalPhysics::SetNbOfPhotonsCerenkov(G4int MaxNumber)
{
